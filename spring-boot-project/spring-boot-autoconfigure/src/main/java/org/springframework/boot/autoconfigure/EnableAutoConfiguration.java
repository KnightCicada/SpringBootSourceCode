 ...
 */
/*
	Enable开头的注解，作用是借助@Import来收集并注册特定场景相关的bean，加载到IOC容器
	@EnableAutoConfiguration收集符合自动配置的bean定义，加载到IOC容器。
 */
...
@Import(AutoConfigurationImportSelector.class) // 底层注解，向容器导入组件
